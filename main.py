...
<html>
    <head>
        ...
        .form-control {
            width: calc(100% - 80px); /* Ajusta para caber no botão */
            display: inline-block;
            margin-right: 10px;
        }

        .btn {
            vertical-align: top; /* Alinha o botão com o campo de entrada */
        }
...
async def websocket_endpoint(websocket: WebSocket, client_id: int):
    ...
    try: 
        while True:
            ...
            await manager.broadcast(f"Usuário #{client_id} Diz: {data}")
